                ...
                <div>
                    <div className={workStyles.workBlock}>
                        <div className={workStyles.imageWrap}>
                            <Image className={workStyles.coverImage} src={lookout} alt="lookout screenshot" fill />
                        </div>
                    ...
                    <div className={workStyles.workBlock}>
                        <div className={workStyles.imageWrap}>
                            <Image className={workStyles.coverImage} src={concerthall} alt="concerthall screenshot" fill />
                        </div>
                        <div className={workStyles.text}>
                            <h2>
                    ...
                    <div className={workStyles.workBlock}>
                        <div className={workStyles.imageWrap}>
                            <Image className={workStyles.coverImage} src={competitive} alt="concerthall screenshot" fill />
                        </div>
                        <div className={workStyles.text}>
                            <h2>
